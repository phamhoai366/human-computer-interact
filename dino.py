...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        # self.label_3.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:7pt;\">Developed by </span><span style=\" font-size:9pt; font-weight:600;\"> Hong Vin (MIT) </span></p></body></html>"))
        ...
        if self.device.isOpened():
            ...
            try:
                while True:
                    ...
                    image = QImage(flipped, width, height, bytesPerLine, QImage.Format.Format_RGB888)
                    pixmap = QPixmap.fromImage(image)
                    pixmap = pixmap.scaled(221, 191, QtCore.Qt.AspectRatioMode.KeepAspectRatio)
                    ...
                    if (center==None):
                        ...
                        if(abs(center[0]-last_center[0])>5 and abs(center[1]-last_center[1]<20)):
                            if(center[0]>last_center[0]):
                                ...
                                pass
                        elif(abs(center[1]-last_center[1]))>15:
...
class App(QtWidgets.QMainWindow, Ui_Dialog):
    ...
    def keyPressEvent(self,event):
        key=event.key()
        if key==QtCore.Qt.Key.Key_Up or (event.type()==QtCore.QEvent.Type.KeyPress and key==QtCore.Qt.Key.Key_Space): 
            self.act='space'
    ...
    def introscreen(self,win):
        ...
        while not gameStart:
            ...
            if pygame.display.get_surface() != None:
                ...
                image=QtGui.QImage(data,width,height,QtGui.QImage.Format.Format_RGB32)
                pixmap = QPixmap.fromImage(image)
